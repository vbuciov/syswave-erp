 ...
 * @author victor
 */
public abstract class CompositeKeyByIdPlaneacionConsecutivo extends PrimaryKeyByConsecutivo
{
        private int[] idPlaneacion;

    //----------------------------------------------------------------------
    public CompositeKeyByIdPlaneacionConsecutivo()
    {
        super();
    ...
    {
        return String.format("%d,%d", getConsecutivo_Viejo(), getIdPlaneacion_Viejo());
    }
    ...
    //---------------------------------------------------------------------
    protected void assign(CompositeKeyByIdPlaneacionConsecutivo that)
    {
        super.assign(that);
