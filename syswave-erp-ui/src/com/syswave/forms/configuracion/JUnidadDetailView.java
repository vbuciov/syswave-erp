 ...
 * @author victor
 */
public class JUnidadDetailView extends javax.swing.JInternalFrame
{

     IUnidadMediator parent;
   boolean esNuevo, construidoArbol;
   Unidad elementoActual;
   
   //---------------------------------------------------------------------
   /**
    * Creates new form JUnidadDetailView
    * @param owner
    */
   public JUnidadDetailView(IUnidadMediator owner)
   {
      initComponents();
      initEvents();
      parent = owner;
   ...
   {
      elementoActual = new Unidad();
      esNuevo = true;
      this.setTitle("Nueva localidad");
   }
   
   //---------------------------------------------------------------------
   public void prepareForModify (Unidad elemento)
   {
   ...
   //---------------------------------------------------------------------
   public void writeElement (Unidad elemento)
   {
      jtfNombre.setText(elemento.getNombre());
      jFormattedTextField1.setValue(elemento.getEscala());
      jckActivo.setSelected(elemento.esActivo());
   }
   
   //---------------------------------------------------------------------
   private boolean readElement (Unidad elemento)
   {
      ...
      if (!jtfNombre.getText().isEmpty() /*&& !jtfSiglas.getText().isEmpty()*/)
      {
         ...
         elemento.setEscala((int)jFormattedTextField1.getValue());
   ...
   private void initComponents()
   {
      ...
      jlbEscala = new javax.swing.JLabel();
      jFormattedTextField1 = new JFormattedTextField(new Integer(1));
      ...
      jlbEscala.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
      jlbEscala.setText("Cantidad respecto al padre:");
      jlbEscala.setHorizontalTextPosition(javax.swing.SwingConstants.LEFT);
      jpContenido.add(jlbEscala);
      jpContenido.add(jFormattedTextField1);
   ...
   private javax.swing.JLabel jlbEscala;
