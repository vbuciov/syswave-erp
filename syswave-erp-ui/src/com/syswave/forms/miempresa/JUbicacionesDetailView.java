 ...
 */
public class JUbicacionesDetailView extends javax.swing.JInternalFrame
{
   IUbicacionMediator parent;
   boolean esNuevo, construidoArbol;
   Ubicacion elementoActual;
   
   //---------------------------------------------------------------------
   /**
    * Creates new form JUbicacionDetailView
    * @param owner
    */
   public JUbicacionesDetailView(IUbicacionMediator owner)
   {
      initComponents();
      initEvents();
      parent = owner;
   ...
   {
      elementoActual = new Ubicacion();
      esNuevo = true;
      this.setTitle("Nueva localidad");
   }
   
   //---------------------------------------------------------------------
   public void prepareForModify (Ubicacion elemento)
   {
   ...
   //---------------------------------------------------------------------
   public void writeElement (Ubicacion elemento)
   {
   ...
   //---------------------------------------------------------------------
   private boolean readElement (Ubicacion elemento)
   {
