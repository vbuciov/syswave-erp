 ...
 */
public class JCategoriaDetailView extends javax.swing.JInternalFrame
{
    ICategoriaMediator parent;
   boolean esNuevo, construidoArbol;
   Categoria elementoActual;
   
   //---------------------------------------------------------------------
   /**
    * Creates new form JCategoriaDetailView
    * @param owner
    */
   public JCategoriaDetailView(ICategoriaMediator owner)
   {
      initComponents();
      initEvents();
      parent = owner;
   ...
   {
      elementoActual = new Categoria();
      esNuevo = true;
      this.setTitle("Nueva localidad");
   }
   
   //---------------------------------------------------------------------
   public void prepareForModify (Categoria elemento)
   {
   ...
   //---------------------------------------------------------------------
   public void writeElement (Categoria elemento)
   {
   ...
   //---------------------------------------------------------------------
   private boolean readElement (Categoria elemento)
   {
